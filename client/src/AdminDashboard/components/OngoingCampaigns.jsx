// This is the OngoingCampaigns component, that shows a list of the ongoing campaigns.
...
const OngoingCampaigns = ({ campaigns }) => {  
  ...
  // Use dummy data if campaigns prop is not provided or undefined
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-50">
              <th className="text-left py-3 px-6 text-xs font-medium text-gray-500 uppercase tracking-wider">Campaign Name</th>
          ...
          <tbody>
            {campaignsData.map((campaign) => (
              <tr key={campaign.id}>
                ...
                <td className="py-4 px-6 text-sm text-gray-900">{campaign.brand}</td>
                <td className="py-4 px-6 text-sm text-gray-900">{campaign.startDate}</td>
