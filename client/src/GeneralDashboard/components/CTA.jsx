        ...
        <div className='flex flex-col justify-start gap-4'>
          <div>
            ...
            <div className='flex flex-col md:flex-row gap-4 mt-2'>
              <Link to="/influencer-signin" className='max-[780px]:w-full'>
                <button className='w-full px-8 text-white py-3 bg-[#104581] rounded-lg hover:bg-[#0d3a6d] transition-all'>
                  As Influencer
                </button>
              </Link>
              <Link to="/brand-signin" className='max-[780px]:w-full'>
                <button className='w-full px-8 text-white py-3 bg-[#104581] rounded-lg hover:bg-[#0d3a6d] transition-all'>
                  As Brand
                </button>
              </Link>
