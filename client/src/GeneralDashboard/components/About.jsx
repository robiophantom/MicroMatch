    ...
    <section className='w-full bg-white p-5'>
        <div className='md:max-w-[1100px] m-auto grid md:grid-cols-2 max-w-[400px]'>
            <div className='flex flex-col justify-start gap-4'>
                ...
                <p className='text-[#536e96]'>MicroMatch is an influencer marketing platform designed for businesses to connect with multiple influencers by prioritizing nano and micro-influencers due to their high engagement rates as compared to big influencers8.</p>
